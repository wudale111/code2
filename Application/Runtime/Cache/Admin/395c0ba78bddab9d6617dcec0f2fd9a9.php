...
<html><head>
    ...
    <!--Basic Styles-->
    <link href="http://127.0.0.1/shop/Application/Admin/Public/style/bootstrap.min.css" rel="stylesheet">
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '/shop/index.php/Admin/Category/add'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
